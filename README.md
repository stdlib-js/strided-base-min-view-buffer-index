...
```javascript
minViewBufferIndex = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-min-view-buffer-index@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-min-view-buffer-index@v0.1.1-umd/browser.js"></script>
```
