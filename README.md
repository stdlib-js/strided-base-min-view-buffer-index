...
```javascript
import minViewBufferIndex from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-min-view-buffer-index@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/strided-base-min-view-buffer-index/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/strided-base-min-view-buffer-index/actions/workflows/test.yml?query=branch:v0.1.1
